...
export default function DashboardPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-950 text-foreground flex flex-col">
            <Navigation />
            <div className="container mx-auto py-10 pt-24 px-4 max-w-4xl flex-1">
                <div className="space-y-6">
                    <div>
                        <Link
                            href="/"
                            className="inline-flex items-center text-sm text-emerald-400/70 hover:text-emerald-400 transition-colors mb-4"
                        >
                            ← Back to Home
                        </Link>
